...
description: To help prevent regression, we want to make sure we run our full test every time we push our code.
pubDate: 06-30-2022
...
status: published
toc: true
heroImage: [../../assets/images/blog/e2e-series-ensure-tests-run-on-every-push/hero.jpg, Github actions showing all specs passing]
---
...
![Run all E2E tests locally with all tests passing](/images/blog/e2e-testing/e2e-run-all-tests-passing.jpg)
...
![Github action running](/images/blog/e2e-testing/gh-e2e-action.jpg)
...
![Adding main branch protection rule](/images/blog/e2e-testing/main-branch-protection-rule.jpg)
...
![Github message showing merges blocked](/images/blog/e2e-testing/gh-merges-blocked.jpg)

Now, undo the change you made and push again and this time you should (eventually) see all green checkmarks.

![Github PR all green checkmarks](/images/blog/e2e-testing/gh-pr-all-green-checks.jpg)
