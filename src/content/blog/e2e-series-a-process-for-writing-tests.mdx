...
pubDate: 09-02-2023
heroImage: [../../assets/images/blog/e2e-series-a-process-for-writing-tests/hero-min.jpg, Cypress test runner with all tests passing]
toc: true
---
import newsLetterSignupForm from '../../assets/images/blog/e2e-series-a-process-for-writing-tests/intro-newsletter-signup-form-min.jpg';
...
{/* ![newsletter form](./blog/e2e-series-a-process-for-writing-tests/newsletter-signup-form.jpg) */}
<Image src={newsLetterSignupForm} alt="Newsletter signup" />
