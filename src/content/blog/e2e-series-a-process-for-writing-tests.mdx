...
![E2E Testing console with test added](/images/blog/e2e-series-a-process-for-writing-tests/e2e-testing-console-with-test-added.jpg)

Go ahead and click on "newsletterSignup" and you should now see the test runner with a list of pending tests.

![Cypress runner with the pending tests](/images/blog/e2e-series-a-process-for-writing-tests/cypress-runner-with-pending-tests.jpg)
...
![E2E Testing console with first failing test](/images/blog/e2e-series-a-process-for-writing-tests/first-failing-test.jpg)
