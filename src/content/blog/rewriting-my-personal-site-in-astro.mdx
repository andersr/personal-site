...
If you've visited my site in the past, you'll likely find that it looks mostly unchanged. But under the hood, nearly everything has changed. That's because I recently decided to rewrite the previous version, built with [NextJS](https://nextjs.org/), with one built with [Astro](https://astro.build/).
...
## Overall I'm happy with making the switch
